...
class PlainConnectionCostTable(
    ...
    companion object {
        ...
        fun readFromInputStream(inputStream: InputStream) : PlainConnectionCostTable {
        ...
        fun writeToOutputStream(outputStream: OutputStream, value: PlainConnectionCostTable) {
